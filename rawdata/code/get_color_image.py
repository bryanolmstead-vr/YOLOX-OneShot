#!/usr/bin/env python3
"""
Fetch a color image over XMLRPC and save it as a PNG.
...
def main():
    parser = argparse.ArgumentParser(description="Fetch image over XMLRPC.")
    ...
    img = fetch_image(args.host, args.port)
    if img is None:
